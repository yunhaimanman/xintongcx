    ...
    try {
      ...
      const mockRoles = [
        ...
        },
        {
          ...
          description: '负责项目管理和执行',
          permissions: [
            { id: 10, name: 'project_manage' },
            { id: 11, name: 'ticket_manage' },
            { id: 12, name: 'report_view' }
          ]
        },
        {
          id: 5,
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">用户管理系统演示</h1>
          <p className="text-gray-600 mt-2">完整的用户管理功能演示，包括用户管理、角色管理和部门管理</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="bg-white shadow-sm">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900">{users.filter(user => user.is_active).length}</div>
            <p className="text-xs text-gray-500">
        ...
        <Card className="bg-white shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">角色数量</CardTitle>
      ...
      <Tabs defaultValue="users" className="space-y-4">
        ...
        <TabsContent value="roles" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {roles.map((role) => (
              <Card key={role.id} className="hover:shadow-md transition-shadow bg-white">
                <CardHeader>
        ...
        <TabsContent value="departments" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {departments.map((department) => (
              <Card key={department.id} className="hover:shadow-md transition-shadow bg-white">
                <CardHeader>
                  <CardTitle className="text-lg flex items-center justify-between">
                    {department.name}
