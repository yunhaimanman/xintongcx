...
import { 
  ...
  TrendingUp, Target, Calendar as CalendarIcon2, FileText
} from 'lucide-react';
      ...
      const mockProjects = [
        {
          id: 1,
          name: '企业级CRM系统开发',
          description: '开发一套完整的客户关系管理系统，包括客户管理、销售管理、营销自动化等功能模块。',
          status: 'active',
          priority: 'high',
          budget: 500000,
        ...
        },
        {
          id: 2,
          name: '移动应用开发项目',
          description: '开发一款企业内部使用的移动应用，支持iOS和Android平台。',
          status: 'planning',
          priority: 'medium',
          budget: 300000,
        ...
        },
        {
          id: 3,
          name: '数据分析平台',
          description: '构建企业数据分析平台，提供实时数据监控和分析报告功能。',
          status: 'completed',
          priority: 'high',
          budget: 800000,
